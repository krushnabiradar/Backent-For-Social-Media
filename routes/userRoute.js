...
const { loginUser, signupUser, logoutUser, followUser, updateProfile, updatePassword, resetPassword, getUserDetails, getAccountDetails, getAllUsers, searchUsers, getUserDetailsById, deleteProfile } = require('../controllers/userController');
